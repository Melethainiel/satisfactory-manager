...
ALTER TABLE "recipe_buildings" RENAME COLUMN "building_class_name" TO "building_id";--> statement-breakpoint
ALTER TABLE "recipe_ingredients" RENAME COLUMN "item_class_name" TO "item_id";--> statement-breakpoint
ALTER TABLE "recipe_products" RENAME COLUMN "item_class_name" TO "item_id";--> statement-breakpoint
