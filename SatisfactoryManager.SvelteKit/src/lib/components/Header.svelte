...
<header
	class="fixed top-0 right-0 left-0 z-40 navbar min-h-16 border-b border-base-200 bg-base-100/80 px-3 shadow-lg backdrop-blur transition-colors supports-[backdrop-filter]:bg-base-100/70 sm:min-h-20 sm:px-4"
>
